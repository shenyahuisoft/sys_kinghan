...
namespace AutoServices.Common
{
    public class SqlHelper
    {
        ...
        {
            SqlConnection Connection = new SqlConnection(connectionString);//SqlHelper.GetConnSting()
            return Connection;
        }
        ...
        /// <param name="timeout">超时时间(以秒为单位)，为0则无限期执行</param>
        /// <remarks>lwj 2013-02-15 添加</remarks>
        public static void SaveDataTable(DataTable dt, string connectionString, string tableName, int timeout = 30)
        {
